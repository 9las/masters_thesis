...
# Get the embedder
embedder = s99_project_functions_bio_embeddings.get_bio_embedder(name = embedding_name_peptide)
...
# Save embeddings
data.to_pickle(path = '../data/s01_embedding_peptide_{}.pkl'.format(embedding_name_peptide))
