...
# Prottrans 2x
data_filtered <- data |>
  filter(model_index %in% c(22, 139:145))
...
ggsave(filename = glue('s13_plot__normalisation__prottrans_t5_xl_u50_2x__auc.svg'),
       plot = p,
       path = "../results",
       width = 30,
       height = 20,
...
ggsave(filename = glue('s13_plot__normalisation__prottrans_t5_xl_u50_2x__auc01.svg'),
       plot = p,
       path = "../results",
       width = 30,
       height = 20,
...
ggsave(filename = glue('s13_plot__normalisation__prottrans_t5_xl_u50_2x__ppv.svg'),
       plot = p,
       path = "../results",
       width = 30,
       height = 20,
